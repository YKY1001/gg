...
void help()
{
	...
	printf("\n       3、修改或者增加学生信息后切记保存！\n");
	printf("\n       4、如果数据有错误，请先修改再保存！\n");
	printf("\n       5、在添加学生时，用两个字符代表不同的性别，比如男用‘M’代替,女用‘W’代替!\n");
	printf("\n       6、保存时，输入的文件名后缀请使用.txt,比如: stu.txt,系统会在源程序\n");
	printf("\n          “学生管理系统.exe”的相同目录建立一个.txt文件来保存学生信息\n");
	printf("\n       7、学生信息包括：姓名、学号、性别、年龄、C语言成绩、高数成绩、英语成绩等！\n");
	printf("\n       8、最后感谢您的使用！\n");
	system("pause");
}
